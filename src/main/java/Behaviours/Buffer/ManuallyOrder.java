...
public class ManuallyOrder extends TickerBehaviour {
    ...
    protected void doSomething() {
        this.agent.location_status[0] = 2;
        this.agent.material_type_matrix[0] = "falan";
        this.agent.material_process_index_matrix[0] = 0;
    }
}
